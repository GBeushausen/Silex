...
class FormServiceProvider implements ServiceProviderInterface
{
    public function register(Container $app)
    {
        ...
        $app['form.extension.PrestoPHP'] = function ($app) {
            return new Form\PrestoPHPFormExtension($app, $app['form.types'], $app['form.type.extensions'], $app['form.type.guessers']);
        };
        ...
        $app['form.extensions'] = function ($app) {
            ...
            $extensions[] = $app['form.extension.PrestoPHP'];
