...
/**
 * HttpKernel Argument Resolver for PrestoPHP.
 *
...
class AppArgumentValueResolver implements ArgumentValueResolverInterface
{
    ...
    {
        return $argument->getType() !== null && (Application::class === $argument->getType() || is_subclass_of($argument->getType(), Application::class));
    }
