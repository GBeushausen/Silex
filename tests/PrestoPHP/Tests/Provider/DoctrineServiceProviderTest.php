...
use PrestoPHP\Provider\DoctrineServiceProvider;
    ...
    public function testMultipleConnections()
    {
        ...
        $app->register(new DoctrineServiceProvider(), [
            'dbs.options' => [
                ...
                'sqlite2' => ['driver' => 'pdo_sqlite', 'path' => sys_get_temp_dir().'/PrestoPHP'],
            ],
        ]);
        ...
        $this->assertEquals(sys_get_temp_dir().'/PrestoPHP', $params['path']);
    }
