...
use PrestoPHP\Tests\Provider\ValidatorServiceProviderTest\Constraint\Custom;
use PrestoPHP\Tests\Provider\ValidatorServiceProviderTest\Constraint\CustomValidator;
...
class ValidatorServiceProviderTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('PrestoPHP\Provider\Validator\ConstraintValidatorFactory', $app['validator.validator_factory']);

        $validator = $app['validator.validator_factory']->getInstance(new Custom());
        $this->assertInstanceOf('PrestoPHP\Tests\Provider\ValidatorServiceProviderTest\Constraint\CustomValidator', $validator);
    }
