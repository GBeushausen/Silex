...
class ApplicationTest extends TestCase
{
    public function testMatchReturnValue()
    {
        ...
        $this->assertInstanceOf('PrestoPHP\Controller', $returnValue);
    ...
    public function testControllersAsMethods()
    {
        ...
        $app->get('/{name}', 'PrestoPHP\Tests\FooController::barAction');
    ...
    public function testApplicationTypeHintWorks()
    {
        ...
        $app->get('/{name}', 'PrestoPHP\Tests\FooController::barSpecialAction');

        $this->assertEquals('Hello Fabien in PrestoPHP\Tests\SpecialApplication', $app->handle(Request::create('/Fabien'))->getContent());
    }
    ...
    public function testPhp7TypeHintWorks()
    {
        ...
        $app->get('/{name}', 'PrestoPHP\Tests\Fixtures\Php7Controller::typehintedAction');
    ...
    public function testRoutesBeforeMiddlewaresTriggeredAfterPrestoPHPBeforeFilters()
    {
        $app = new Application();
    ...
    public function testRoutesAfterMiddlewaresTriggeredBeforePrestoPHPAfterFilters()
    {
        $app = new Application();
    ...
    public function testOverriddenRoutesFactory()
    {
        ...
        $this->assertInstanceOf('PrestoPHP\Tests\RouteCollectionSubClass', $app['routes']);
    }
}
